...
public class VarargsEx {
    public static void main(String[] args) {
        ...
        System.out.println(object.calculateSum(20,2));
        System.out.println(object.calculateSum(20,2,5));
        ...
        object.showAverageOfStudent("larisa",8, 10, 9, 7);

        System.out.println("--------------------------------------------");
        System.out.println(object.findTheLongestName("Alexandra", "Violeta", "Paul", "caine"));
